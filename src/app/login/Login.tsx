...
export default function Login() {
  ...
  return (
    <div className="h-screen w-screen bg-gradient-to-l from-white to-pa-primary flex">
      ...
      <div className="h-full w-3/5 flex flex-col justify-center items-center">
        ...
        />
        <div className="font-bold text-pa-primary text-3xl my-4 animate-fade-up animate-duration-[1500ms] animate-delay-500">
