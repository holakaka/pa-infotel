...
export default function LeftBar(): ReactElement {
  ...
  return (
    <div className="h-full w-[305px] flex flex-col bg-pa-home-blue drop-shadow-xl ">
      <Link href={"/home"}>
        <div
      ...
      <div className="flex-1 flex flex-col gap-y-4 ">
          ...
          <div
            className={`${
              tabSelected === 1
                ...
                : "text-white"
            } h-16 hover:bg-pa-home-grey hover:animate-fade-left hover:cursor-pointer  hover:text-pa-home-blue rounded-l-full flex`}
        ...
        <div
          className="h-16 hover:bg-pa-home-grey hover:animate-fade-left hover:cursor-pointer text-white hover:text-pa-home-blue rounded-l-full flex"
